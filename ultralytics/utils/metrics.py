...
##############################################################################
# Version 2.0.0 
# Original add SD Loss function
# delta是SD Loss新增的参数，默认值为0.5
# @TODO 引入SD Loss损失函数-20260715
##############################################################################
def bbox_iou(box1, box2, xywh=True, GIoU=False, DIoU=False, CIoU=False, SDIoU=False, eps=1e-7, delta=0.5):
    """
...
##############################################################################
# Powerful-IoU / PIoU function
# @TODO 引入Power-Iful-IoU损失函数-20260716
##############################################################################
