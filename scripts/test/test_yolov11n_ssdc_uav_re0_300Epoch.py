...
def test():
    """
    SSDC-UAV 数据集测试脚本 (YOLO11n)

    功能：
    1. 加载训练好的 YOLO11n模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_size-n\from_scratch\yolo11n_ssdc_uav_re0_exp01_300Epoch\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo11n_ssdc_uav_re0_exp01_300Epoch',
