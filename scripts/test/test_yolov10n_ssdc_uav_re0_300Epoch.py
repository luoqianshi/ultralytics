...
def test():
    """
    SSDC-UAV 数据集测试脚本 (YOLOv10n)

    功能：
    1. 加载训练好的 YOLOv10n 模型权重。
    ...
    # 权重文件路径 (训练好的 best.pt)
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_size-n\from_scratch\yolov10n_ssdc_uav_re0_exp01_300Epoch\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolov10n_ssdc_uav_re0_exp01_300Epoch',
