...
def test():
    """
    SSDC-UAV 数据集测试脚本 (YOLOv8n)

    功能：
    1. 加载训练好的 YOLOv8n模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_size-n\from_scratch\yolov8n_ssdc_uav_re0_exp01_300Epoch\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolov8n_ssdc_uav_re0_exp01_300Epoch',
