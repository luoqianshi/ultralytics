...
def test():
    """
    SSDC-UAV 数据集测试脚本 (E1: YOLO11s)

    功能：
    1. 加载训练好的 YOLO11s模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_re0\from_scratch\yolo11s_ssdc_uav_re0_exp01\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo11s_ssdc_uav_re0_exp01',
