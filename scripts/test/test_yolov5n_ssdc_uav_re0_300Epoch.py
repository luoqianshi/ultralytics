...
def test():
    """
    SSDC-UAV 数据集测试脚本 (YOLOv5n)

    功能：
    1. 加载训练好的 YOLOv5n模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_size-n\from_scratch\yolov5n_ssdc_uav_re0_exp01_300Epoch\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolov5n_ssdc_uav_re0_exp01_300Epoch',
