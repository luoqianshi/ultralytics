...
def test_yolov11_ssdc_uav_re0():
    """
    YOLOv11 SSDC-UAV 数据集测试脚本
    
    功能：
    1. 加载训练好的 YOLOv11 模型权重。
    ...
    # 权重文件路径
    # @TODO 记得替换best权重参数
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo11s_ssdc_uav_re0_exp01\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo11s_ssdc_uav_test_exp_re0',
