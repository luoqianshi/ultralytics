...
def test_yolov12_ssdc_uav_re0_300Epoch():
    """
    ...
    # 权重文件路径
    # @TODO 记得替换best权重参数
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12s_ssdc_uav_re0_exp02_300Epoch\weights\best.pt')
...
if __name__ == '__main__':
    # @TODO 使用正确的测试脚本
    test_yolov12_ssdc_uav_re0_300Epoch()
