...
def test():
    """
    SSDC-UAV 数据集测试脚本 (YOLOv9t)

    功能：
    1. 加载训练好的 YOLOv9t 模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_size-n\from_scratch\yolov9t_ssdc_uav_re0_exp01_300Epoch\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolov9t_ssdc_uav_re0_exp01_300Epoch',
