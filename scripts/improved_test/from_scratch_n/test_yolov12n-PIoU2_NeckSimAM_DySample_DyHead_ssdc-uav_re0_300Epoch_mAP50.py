...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12n-PIoU2_NeckSimAM-DySample_DyHead'
Epoch = 300
Type = 'from_scratch'

def test():
    """
    SSDC-UAV 数据集测试脚本 (E1: YOLO12n + PIoU2 + NeckSimAM + DySample + DyHead)
    """
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_size-n\from_scratch\yolo12n_PIoU2_NeckSimAM_DySample_DyHead_ssdc_uav_exp1_re0_300Epoch_mAP50\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12n-PIoU2_NeckSimAM-DySample_DyHead_ssdc_uav_exp1_re0_300Epoch_mAP50',
