...
def test_yolov12_nwd_ssdc_uav_re0():
    """
    YOLOv12-NWD SSDC-UAV 数据集测试脚本
    
    功能：
    1. 加载训练好的 YOLOv12-NWD 模型权重。
    ...
    # 权重文件路径
    # @TODO 记得替换best权重参数
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolov12-NWD_ssdc-uav_re0_exp01\weights\best.pt')
    ...
    print("=" * 50)
    print("YOLOv12-NWD SSDC-UAV 测试脚本启动")
    print("=" * 50)
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolov12-NWD_ssdc-uav_test_exp_re0',
