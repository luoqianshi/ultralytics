...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12n-Focaler-CIoU'  # 200 Epoch 训练, Focaler_CIou 替代 CIoU
Epoch = 200
Type = 'coco_pretrain'
...
def test():
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12n_Focaler-CIoU_ssdc_uav_exp1\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12n_Focaler-CIoU_ssdc_uav_exp1',
