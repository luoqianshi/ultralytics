...
def test():
    ...
    # 权重文件路径
    # @TODO 记得替换best权重参数
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12n_DySample_ssdc_uav_exp01_200Epoch\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12n_DySample_ssdc_uav_test_exp1_200Epoch',
