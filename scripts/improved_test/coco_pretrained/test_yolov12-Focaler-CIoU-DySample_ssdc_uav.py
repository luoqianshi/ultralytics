...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12s-Focaler-CIoU-DySample'  # 150 Epoch 训练
Epoch = 150
Type = 'coco_pretrain'
...
def test():
    ...
    功能：
    1. 加载训练好的 YOLO12s + Focaler-CIoU + DySample 模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12s_Focaler-CIoU-DySample_ssdc_uav_exp1\weights\best.pt')
    ...
    if not weights_path.exists():
        ...
        print("训练脚本: scripts/improved_train/coco_pretrained/train_yolov12-Focaler-CIoU-DySample_ssdc-uav.py")
        return
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_Focaler-CIoU-DySample_ssdc_uav_exp1',
