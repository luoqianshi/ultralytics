...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12s-PIoU2-DySample_DyHead_EMA'
Epoch = 150
Type = 'coco_pretrain'
...
def test():
    """
    SSDC-UAV 数据集测试脚本 (E1: YOLO12s + PIoU2 + DySample + DyHead + EMA[Neck])
    """
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12_PIoU2_DySample_DyHead_EMA_ssdc_uav_exp01\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_PIoU2-DySample_DyHead_EMA_ssdc_uav_exp1',
