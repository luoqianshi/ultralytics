...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12s-SD_Loss'  # 150 Epoch 训练, SD Loss
Epoch = 150
Type = 'coco_pretrain'
...
def test():
    """
    SSDC-UAV 数据集测试脚本 (E1: YOLO12s + SD Loss)

    功能：
    1. 加载训练好的 YOLO12s + SD Loss 模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12s_SD-Loss_ssdc_uav_exp1\weights\best.pt')
    ...
    if not weights_path.exists():
        ...
        print("训练脚本: scripts/improved_train/coco_pretrained/train_yolov12-SD_Loss_ssdc-uav.py")
        return
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_SD_Loss_ssdc_uav_exp1',
