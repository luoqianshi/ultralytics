...
def test_yolov12_A2C2f_Mona_ssdc_uav():
    """
    ...
    # 权重文件路径
    # @TODO 记得替换best权重参数
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12_A2C2f_Mona_ssdc_uav_exp01\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_A2C2f_Mona_ssdc_uav_test_exp',
...
if __name__ == '__main__':
    # @TODO 使用正确的测试脚本
    test_yolov12_A2C2f_Mona_ssdc_uav()
