...
# 在这里统一记录关键的测试参数
Model = 'YOLO12s_PIoU2_FreqFusion_up'
Epoch = 150
# Type = 'from_scratch'
Type = 'coco_pretrain'
...
def test():
    ...
    # 权重文件路径
    # @TODO 记得替换best权重参数
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12s_PIoU2_FreqFusion_up_ssdc_uav_exp01\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_PIoU2_FreqFusion_up_ssdc_uav_test_exp1',
