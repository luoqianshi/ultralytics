...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12s-Varifocal_Loss'  # 150 Epoch 训练, Varifocal_Loss 替代 BCE Loss
Epoch = 150
Type = 'coco_pretrain'
...
def test():
    """
    SSDC-UAV 数据集测试脚本 (E1: YOLO12s + Varifocal_Loss)

    功能：
    1. 加载训练好的 YOLO12s + Varifocal_Loss 模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo12s_Varifocal_Loss_ssdc_uav_exp1\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_Varifocal_Loss_ssdc_uav_exp1',
