...
def test():
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_re0\from_scratch_new_improve\yolo12s_Focaler-CIoU_ssdc_uav_exp1_re0\weights\best.pt')
