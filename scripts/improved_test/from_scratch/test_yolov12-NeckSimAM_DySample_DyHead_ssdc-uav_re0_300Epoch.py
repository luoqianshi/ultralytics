...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12s-NeckSimAM-DySample-DyHead'  # 300 Epoch 训练
Epoch = 300
# Type = 'coco_pretrain'
Type = 'from_scratch'
...
def test():
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_re0\from_scratch_new_improve\yolo12s_NeckSimAM_DySample_DyHead_ssdc_uav_exp1_re0_300Epoch\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_NeckSimAM-DySample_DyHead_ssdc_uav_exp1_300Epoch',
