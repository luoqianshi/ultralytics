...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12s-NeckSimAM-DySample-DyHead_mAP50'  # 300 Epoch 训练
Epoch = 300
# Type = 'coco_pretrain'
Type = 'from_scratch'
...
def test():
    """
    SSDC-UAV 数据集测试脚本 (E1: YOLO12s + NeckSimAM + DySample + DyHead)

    功能：
    1. 加载训练好的 YOLO12s + NeckSimAM + DySample + DyHead 模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_re0\from_scratch_new_improve\yolo12s_NeckSimAM_DySample_DyHead_ssdc_uav_exp1_re0_300Epoch_mAP50\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_NeckSimAM-DySample_DyHead_ssdc_uav_exp1_300Epoch_mAP50',
