...
# 在这里统一记录关键的测试参数
Model = 'YOLOv12s-DySample-plus'  # 300 Epoch 训练, DySample-plus
Epoch = 300
# Type = 'coco_pretrain'
Type = 'from_scratch'
...
def test():
    """
    SSDC-UAV 数据集测试脚本 (E1: YOLO12s + DySample-plus)

    功能：
    1. 加载训练好的 YOLO12s + DySample-plus 模型权重。
    ...
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train_re0\from_scratch_new_improve\yolo12s_DySample-plus_ssdc_uav_exp02_re0_300Epoch\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo12s_DySample-plus_ssdc_uav_exp02_300Epoch',
