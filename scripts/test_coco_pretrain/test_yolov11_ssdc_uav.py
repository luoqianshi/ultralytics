...
def test():
    ...
    # 权重文件路径
    # @TODO 记得替换best权重参数
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo11s_ssdc_uav_exp01\weights\best.pt')
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo11s_ssdc_uav_test_exp01',
