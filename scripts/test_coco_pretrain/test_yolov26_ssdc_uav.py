...
def test_yolov26_ssdc_uav():
    ...
    # 权重文件路径
    # @TODO 记得替换best权重参数
    weights_path = Path(r'D:\Data\New_Codes\Python_Codes\ultralytics\runs\ssdc_uav_train\yolo26s_ssdc_uav_exp01\weights\best.pt')
    ...
    print("=" * 50)
    print("YOLOv26 SSDC-UAV COCO Pretrain测试脚本启动")
    print("=" * 50)
    ...
    try:
        ...
        metrics = model.val(
            ...
            name='yolo26s_ssdc_uav_test_exp01',
