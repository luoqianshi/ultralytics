...
def train():
    """
    YOLOv9 训练脚本
    用于在 SSDC-UAV 数据集上训练 YOLOv9 模型，并进行公平性配置。
    """
    # 1. 配置路径
    ...
    ## 注意：YOLOv9 官方没有 n 规格，t (tiny) 是最小规格，参数量与 n 规格最接近
    ## 重零训练模型的配置文件在：ultralytics\cfg\models\v9
    ...
    results = model.train(
        ...
        name='yolov9t_ssdc_uav_re0_exp01_300Epoch',# 实验名称
