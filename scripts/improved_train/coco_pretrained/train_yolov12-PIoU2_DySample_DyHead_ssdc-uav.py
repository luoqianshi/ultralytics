...
`   YOLO12 + DySample + DyHead + Powerful-CIoU2 训练脚本
    ...
    # 2. 加载模型
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12s-DySample_DyHead.yaml')
    ...
    results = model.train(
        ...
        name='yolo12s_PIoU2-DySample_DyHead_ssdc_uav_exp1',  # 实验名称
