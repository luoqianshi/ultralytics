...
def train():
    ...
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12s-Detect_DyHead.yaml')
    ...
    results = model.train(
        ...
        name='yolo12s_Detect-DyHead_ssdc_uav_exp01',# 实验名称
