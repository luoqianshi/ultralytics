...
def train():
    """
    YOLOv12 + DySample + WIoU v3训练脚本
    - 预训练权重: yolo12s.pt (COCO)
    - 数据集: SSDC-UAV
    - 训练: 150 epochs, imgsz=640, batch=16, SGD
    ...
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12s-DySample.yaml')
