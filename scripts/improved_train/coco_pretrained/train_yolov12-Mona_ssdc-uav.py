...
def train():
    """
    YOLOv12-Mona 训练脚本
    用于在 SSDC-UAV 数据集上训练 YOLOv12-Mona 模型，并进行公平性配置。
    """
    # 1. 配置路径
    ...
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12s-Mona.yaml')
    ...
    results = model.train(
        ...
        name='yolo12_Mona_ssdc_uav_exp01',# 实验名称
