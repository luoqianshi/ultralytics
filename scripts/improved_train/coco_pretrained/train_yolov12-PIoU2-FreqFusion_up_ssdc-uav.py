...
def train():
    """
    YOLOv12-FreqFusion_up 训练脚本
    用于在 SSDC-UAV 数据集上训练 YOLOv12-FreqFusion_up 模型（自输入式 FreqFusion 上采样器，
    ...
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12s-FreqFusion_up.yaml')
    ...
    # 3. 开始训练
    # 与 DySample 组严格对齐（对比对象就是 DySample，协议必须逐项一致）：
    # - Optimizer: SGD
    # - Epochs: 150
    ...
    results = model.train(
        ...
        name='yolo12s_PIoU2_FreqFusion_up_ssdc_uav_exp01',# 实验名称
