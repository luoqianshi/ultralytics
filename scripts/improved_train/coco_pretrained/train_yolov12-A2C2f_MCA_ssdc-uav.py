...
def train():
    ...
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12s-A2C2f_MCA.yaml')
    ...
    results = model.train(
        ...
        name='yolo12s_A2C2f_MCA_ssdc_uav_exp1',  # 实验名称
