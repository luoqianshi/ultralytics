...
def train():
    """
`   YOLO12 + NeckSimAM + DyHead + Powerful-CIoU2 训练脚本
    - 数据集: SSDC-UAV
    ...
    # 2. 加载模型
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12n-NeckSimAM_DyHead.yaml')
    ...
    results = model.train(
        ...
        name='yolo12n_PIoU2_NeckSimAM_DyHead_ssdc_uav_exp1_re0_300Epoch_mAP50',  # 实验名称
