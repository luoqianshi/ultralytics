...
def train():
    """
    YOLOv12_HPDown 训练脚本
    用于在 SSDC-UAV 数据集上训练 YOLOv12_HPDown 模型，并进行公平性配置。
    """
    # 1. 配置路径
    ...
    ## @TODO:重零训练模型的配置文件在：ultralytics\scripts\improved_yolo12\yolo12s-HPDown.yaml
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12s-HPDown.yaml')
    ...
    results = model.train(
        ...
        name='yolo12s-HPDown_ssdc_uav_re0_exp01',# 实验名称
