...
`   YOLO12 + DySample + DyHead + NeckSimAM 训练脚本
    ...
    # 2. 加载模型
    model = YOLO(r'D:\Data\New_Codes\Python_Codes\ultralytics\scripts\improved_yolo12\yolo12s-NeckSimAM_DySample_DyHead.yaml')
    ...
    results = model.train(
        ...
        name='yolo12s_NeckSimAM_DySample_DyHead_ssdc_uav_exp1_re0_300Epoch_mAP50',  # 实验名称
